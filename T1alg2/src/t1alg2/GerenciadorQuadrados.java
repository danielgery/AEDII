...
public class GerenciadorQuadrados {
	...
	public static void contaCores() {
		...
		aux = verdeclaro;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de verde-claro");
		}
		aux = vermelho;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de vermelho");
		}
		aux = azulclaro;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de azul-claro");
		}
		aux = amarelo;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de amarelo");
		}
		aux = verdeescuro;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de verde-escuro");
		}
		aux = marrom;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de marrom");
		}
		aux = azulescuro;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de azul-escuro");
		}
		aux = cinza;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de cinza");
		}
		aux = dourado;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de dourado");
		}
		aux = violeta;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de violeta");
		}
		aux = preto;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de preto");
		}
		aux = laranja;
		if (aux > 0) {
			System.out.println(aux + " unidades ser�o pintadas de laranja");
		}
	}
}
